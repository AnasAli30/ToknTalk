            ...
            <form onSubmit={handleSearch} className="relative">
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-10 py-3 bg-background border border-border rounded-xl text-text-primary placeholder-text-secondary focus:border-accent focus:outline-none transition-all duration-300"
                />
                {searchQuery && (
                  <button
                    type="button"
                    ...
                    <div className="p-4">
                      ...
                      <div className="space-y-2">
                        <button
                          ...
                          className="flex items-center gap-2 w-full p-2 hover:bg-background rounded-lg transition-colors text-left"
                        >
